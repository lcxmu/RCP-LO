...
class kittiOdomEval():
    ...
    def loadPoses2(self, file_name, toCameraCoord):
        '''
            Each line in the file should follow one of the following structures
            (1) idx pose(3x4 matrix in terms of 12 numbers)
            (2) pose(3x4 matrix in terms of 12 numbers)
    ...
    def eval(self, toCameraCoord):
        ...
        for seq in self.eval_seqs:
            ...
            #gt_file_name = self.gt_dir + '/{}_diff.npy'.format(seq)
            ...
            #if str(seq + '_diff') not in self.seqs_with_gt:
            ...
            poses_gt = self.loadPoses2(gt_file_name, toCameraCoord=False)            
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt_dir', type=str, default='./ground_truth_pose/Pose_GT_loop' ,
                        help='Directory path of the ground truth odometry')  
    parser.add_argument('--result_dir', type=str, default='./',
                        help='Directory path of storing the odometry results')
    parser.add_argument('--eva_seqs', type=str, default='07_pred', help='The sequences to be evaluated')
